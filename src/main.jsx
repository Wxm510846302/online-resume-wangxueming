...
const assistantReplies = {
  ...
  sdk:
    "我集成过 50+ 第三方 SDK，覆盖支付、推送、统计、地图、IM、RTC、海外登录和归因生态，包括微信、支付宝、友盟、极光、高德、Facebook、Google、Adjust、Firebase、Kakao、融云、火山 RTC 等。在蓝港项目里重构过游戏登录/支付 SDK，支付掉单率从 0.2‰ 降至 ≤0.05‰。",
  projects:
      ...
      <main>
        <section className="hero" id="top">
          <div className="hero-copy">
            ...
            <p className="summary">iOS客户端开发出身,10+ 年移动端与全栈研发经验，主导服务全国百万级用户的跨端产品与 SDK 架构落地</p>
  ...
  return (
    <article className="timeline-panel" id="timeline">
      <div className="panel-head">
        ...
        >
          {expanded ? "收起经历" : "完整经历"} <ArrowUpRight size={15} />
        </button>
      </div>
